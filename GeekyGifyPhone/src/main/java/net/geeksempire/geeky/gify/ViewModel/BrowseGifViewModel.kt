...
class BrowseGifViewModel : ViewModel() {
    ...
    fun setupCollectionGifsBrowseData(rawDataFiles: List<File>, colorsList: ArrayList<String>) = CoroutineScope(SupervisorJob() + Dispatchers.IO).launch {
